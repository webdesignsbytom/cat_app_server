  ...
  const videos = [
    {
      ...
      path: `bucket=catapp&folder=videos%2Fcotd&videoName=cat_video1.mp4`,
      size: 150000000,
      duration: 120.5,
      codec: 'H.264',
      width: 1280,
    ...
    },
    {
      ...
      name: 'cat_video_2',
      videoStatus: 'APPROVED',
      path: `bucket=catapp&folder=videos%2Fcotd&videoName=cat_video2.mp4`,
      size: 200000000,
      duration: 150.0,
      codec: 'H.265',
      width: 1920,
    ...
    },
    {
      ...
      name: 'cat_video_3',
      videoStatus: 'APPROVED',
      path: `bucket=catapp&folder=videos%2Fcotd&videoName=cat_video3.mp4`,
      size: 300000000,
      duration: 180.0,
      codec: 'H.264',
      width: 1280,
    ...
    },
    {
      ...
      name: 'cat_video_4',
      videoStatus: 'APPROVED',
      path: `bucket=catapp&folder=videos%2Fcotd&videoName=cat_video4.mp4`,
      size: 250000000,
      duration: 200.0,
      codec: 'H.264',
      width: 1280,
    ...
    },
    {
      ...
      name: 'cat_video_5',
      videoStatus: 'PENDING',
      path: `bucket=catapp&folder=videos%2Freview&videoName=cat_video5.mp4`,
      size: 180000000,
      duration: 160.0,
      codec: 'H.265',
      width: 1920,
    ...
    },
    {
      ...
      name: 'cat_video_6',
      videoStatus: 'PENDING',
      path: `bucket=catapp&folder=videos%2Freview&videoName=cat_video6.mp4`,
      size: 250000000,
      duration: 200.0,
      codec: 'H.264',
      width: 1280,
    ...
    },
    {
      ...
      name: 'cat_video_7',
      videoStatus: 'PENDING',
      path: `bucket=catapp&folder=videos%2Freview&videoName=cat_video7.mp4`,
      size: 180000000,
      duration: 160.0,
      codec: 'H.265',
      width: 1920,
    ...
    },
    {
      ...
      name: 'cat_video_8',
      videoStatus: 'DELETED',
      path: `bucket=catapp&folder=videos%2Fdeleted&videoName=cat_video8.mp4`,
      size: 180000000,
      duration: 160.0,
      codec: 'H.265',
      width: 1920,
    ...
    },
    {
      ...
      name: 'cat_video_9',
      videoStatus: 'DELETED',
      path: `bucket=catapp&folder=videos%2Fdeleted&videoName=cat_video9.mp4`,
      size: 180000000,
      duration: 160.0,
      codec: 'H.265',
      width: 1920,
