  ...
  const videos = [
    {
      ...
      path: `http://${bucketUrl}/catapp/videos/cotd/1718827609082.mp4`,
      size: 150000000,
      duration: 120.5,
      codec: 'H.264',
      width: 1280,
    ...
    },
    {
      ...
      name: 'cat_video_2',
      videoStatus: 'APPROVED',
      path: `http://${bucketUrl}/catapp/videos/cotd/1718827753523.mp4`,
      size: 200000000,
      duration: 150.0,
      codec: 'H.265',
      width: 1920,
    ...
    },
    {
      ...
      name: 'cat_video_3',
      videoStatus: 'APPROVED',
      path: `http://${bucketUrl}/catapp/videos/cotd/1718827868190.mp4`,
      size: 300000000,
      duration: 180.0,
      codec: 'H.264',
      width: 1280,
    ...
    },
    {
      ...
      name: 'cat_video_4',
      videoStatus: 'APPROVED',
      path: `http://${bucketUrl}/catapp/videos/cotd/1718827903169.mp4`,
      size: 250000000,
      duration: 200.0,
      codec: 'H.264',
      width: 1280,
    ...
    },
    {
      ...
      name: 'cat_video_5',
      videoStatus: 'APPROVED',
      path: `http://${bucketUrl}/catapp/videos/cotd/1718828165218.mp4`,
      size: 180000000,
      duration: 160.0,
      codec: 'H.265',
      width: 1920,
